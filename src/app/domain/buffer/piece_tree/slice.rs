use super::{ByteSpan, PieceTreeLite, PieceTreeSlice, PieceTreeSpan, byte_range_for_char_range};
use std::ops::Range;

mod previews;
pub(super) use previews::{
    previews_for_matches_in_contiguous_text, previews_for_matches_in_piece_spans,
};
