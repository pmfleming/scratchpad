...
pub use buffer::{
    ...
    BufferViewStatus, DiskFileState, DocumentSnapshot, EncodingSource, LineEndingCounts,
    LineEndingStyle, RestoredBufferState, TextArtifactSummary, TextDocument, TextFormatMetadata,
