...
FLAMEGRAPH_CONFIGS = [
    ...
    },
    {
        ...
        "benchmark_keys": ["search_current_app_state_completion_aggregate_size"],
        "workload_families": ["search"],
        "coverage_role": "report-driven",
        "resource_focus": "cpu",
        "description": "Current-tab app-state search through the full Scratchpad search pipeline.",
    },
    {
        "id": "search_all_tabs_profile",
        "name": "Search All Tabs Profile",
        "cargo_args": ["--bin", "profile_search_all_tabs"],
        "benchmark_keys": ["search_all_completion_aggregate_size"],
        "workload_families": ["search"],
        "coverage_role": "report-driven",
        "resource_focus": "cpu",
